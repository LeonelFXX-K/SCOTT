<nav class="fixed shadow top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                <div class="flex items-center ms-3">
                    ...
                    <button type="button"
                        class="mr-4 relative inline-flex items-center p-2.5 text-sm font-medium text-center text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg">
                        <i class="fa-solid fa-bell text-base"></i>
                        <span class="sr-only">Notifications</span>
                        <div
                            class="absolute inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-red-500 rounded-full -top-1 -end-2 dark:border-gray-900">
                            20
                        </div>
                    </button>
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link href="{{ route('profile.show') }}" class="flex justify-start items-center">
