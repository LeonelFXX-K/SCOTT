    ...
    <form wire:submit.prevent="saveReport">
        <div class="space-y-4">
            ...
            @foreach ($categories as $index => $category)
                <div x-data="{ open: true, editingName: false }" class="p-4 bg-white border rounded-lg shadow-2xl">
                    <div class="flex items-center justify-between cursor-pointer" @click="open = !open">
                        <div class="flex items-center">
                            ...
                            <span
                                ...
                                {{ count($category['channels']) > 1 ? __('channels') : __('channel') }}
                            </span>
                        </div>
                    ...
                    <div x-show="open" class="mt-4">
                        ...
                        @foreach ($category['channels'] as $channelIndex => $channel)
                            <div class="p-4 bg-white border rounded-lg shadow-2xl mb-4">
                                <div class="flex items-center justify-between mb-3">
                                    <h4 class="text-md font-semibold">{{ __('Channel') }} {{ $channelIndex + 1 }}</h4>
                                    <button type="button"
            ...
            <button type="button" wire:click="addCategory" class="text-green-600 hover:text-green-800">
