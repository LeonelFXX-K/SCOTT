                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs uppercase bg-gray-100 dark:bg-gray-600 shadow-2xl">
                            <tr>
                                <th scope="col" class="px-4 py-3"><i class="fa-solid fa-tv mr-1"></i>
                                    {{ __('Detalles del canal') }}</th>
                                <th scope="col" class="px-4 py-3"><i class="fa-solid fa-clock mr-1"></i>
                                    {{ __('Hora') }}</th>
                                <th scope="col" class="px-4 py-3"><i class="fa-solid fa-layer-group mr-1"></i>
                                    {{ __('Etapa y Protocolo') }}</th>
                                <th scope="col" class="px-4 py-3"><i class="fa-solid fa-user mr-1"></i>
                                    {{ __('Reportado por') }}</th>
                                <th scope="col" class="px-4 py-3"><i class="fa-solid fa-toggle-on mr-1"></i>
                                    {{ __('Estado') }}</th>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-600">
                                ...
                                <td class="px-4 py-2.5"><span
                                        class="inline-flex items-center px-3 py-2 text-xs font-medium text-gray-700 bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-200"><i
                                            class="fa-solid fa-clock mr-1"></i> 10:30</span></td>
                                <!-- Etapa y Protocolo -->
                                <td class="px-4 py-2.5">
                                    <span
                                        class="inline-flex items-center px-3 py-1 text-xs font-medium text-blue-800 bg-blue-200 rounded-full dark:bg-blue-800 dark:text-blue-200"><i
                                            class="fas fa-folder-open mr-1"></i> CDN TELMEX
                                        <span
                                ...
                                <!-- Avatar del usuario -->
                                <td class="px-4 py-2.5 flex justify-center items-center">
                                    <div>
                                        ...
                                        <img data-tooltip-target="tooltip" class="w-10 h-10 rounded-full shadow-2xl"
                                            src="{{ Auth::user()->profile_photo_url }}" alt="Medium avatar">
                                    </div>

                                </td>
                                <!-- Estado del reporte -->
                                <td class="px-4 py-2.5"><span
                                        class="inline-flex items-center px-3 py-2 text-xs font-medium text-yellow-800 bg-yellow-200 rounded-full dark:bg-yellow-800 dark:text-yellow-200"><i
                                            class="fas fa-circle-exclamation mr-1"></i> En revisión</span></td>
                                <!-- Opciones -->
